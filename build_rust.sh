#!/bin/bash
# Build the aphrodite-rs Rust frontend binary and install it into the aphrodite package.
...
TARGET_PATH="$REPO_ROOT/aphrodite/aphrodite-rs"
...
cp "$RUST_DIR/target/$PROFILE_DIR/aphrodite-rs" "$TARGET_PATH"
echo "Installed aphrodite-rs to $TARGET_PATH"
