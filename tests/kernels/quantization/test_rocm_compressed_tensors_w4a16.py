...
def test_rocm_compressed_tensors_w4a16_e2e(aphrodite_runner, example_prompts, model_path, max_tokens):
    # Use fp16 activations for maximum compatibility.
    # gpu_memory_utilization lowered to work on shared nodes.
    with aphrodite_runner(model_path, dtype="float16", gpu_memory_utilization=0.3) as aphrodite_model:
