...
def test_bf16x3_router_gemm_matches_reference(num_tokens: int, hidden_dim: int, num_experts: int):
    _requires_sm100_cutedsl()
    from aphrodite.model_executor.layers.fused_moe.router.bf16x3_router_gemm_cutedsl import (  # noqa: E501
        bf16x3_router_gemm,
    )
