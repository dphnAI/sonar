...
class TestNonStreaming:
    ...
    def test_single_tool_call(self, parser, mock_request):
        ...
        result = parser.extract_tool_calls(text, token_ids=None, request=mock_request)
    ...
    def test_multiple_parameters(self, parser, mock_request):
        text = (
            "<tool_call>\n<function=search>\n"
            "<parameter=query>aphrodite parsing</parameter>\n"
...
class TestAnyOfTypeCoercion:
    ...
    def test_anyof_string_param_not_coerced(self, parser_with_anyof, mock_request):
        ...
        result = parser_with_anyof.extract_tool_calls(text, token_ids=None, request=mock_request)
        assert result.tools_called
        args = json.loads(result.tool_calls[0].function.arguments)
