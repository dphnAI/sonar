...
from aphrodite.v1.spec_decode.vocab_mapping import _detect_space_prefix
...
def test_detect_space_prefix_real_tokenizers(model_name, expected_prefix):
    ...
    assert result == expected_prefix, f"{model_name}: expected {expected_prefix!r}, got {result!r}"
