...
from aphrodite.model_executor.layers.vocab_parallel_embedding import pad_vocab_size
...
def test_flashinfer_sample_padded_vocab(dtype: torch.dtype, k: int | None, p: float | None):
    ...
    logits = torch.randn(batch_size, padded_vocab_size, dtype=dtype)[..., :org_vocab_size]
