...
Aphrodite server and compare BS=1 vs BS=N results (tokens and per-step logprobs).

Environment variables:
  - APHRODITE_TEST_MODEL: served model name (e.g., Qwen/Qwen3-1.7B / DeepSeek-R1)
  - APHRODITE_TP_SIZE: tensor parallelism size (e.g., 4)
...
def test_logprobs_bitwise_batch_invariance_bs1_vs_bsN(
    ...
    random.seed(int(os.getenv("APHRODITE_TEST_SEED", "12345")))
    ...
    tp_size = os.getenv("APHRODITE_TP_SIZE", "1")
