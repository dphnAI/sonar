...
from aphrodite.distributed.kv_events import MEDIUM_CPU, MEDIUM_FS, BlockRemoved, BlockStored
...
def test_tiering_rejects_self_describing_kv_events():
    ...
    with pytest.raises(ValueError, match="TieringOffloadingSpec"):
        TieringOffloadingSpec(build_offloading_config(aphrodite_config, kv_cache_config))
