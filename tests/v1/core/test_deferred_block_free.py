...
MODEL = os.environ.get("APHRODITE_TEST_DEFER_FREE_MODEL", "facebook/opt-125m")
STOP_TOKEN_ID = 42
...
def test_cow_retentions_deferred_until_copy_step_processed():
    ...
    block_copy = KVCacheBlockCopy(src_block_id=src_block.block_id, dst_block_id=dst_block.block_id)
