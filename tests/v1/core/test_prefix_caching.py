...
from aphrodite.distributed.kv_events import AllBlocksCleared, BlockRemoved, BlockStored
...
def test_hybrid_cache_mamba_align_shared_prefix_detection():
    ...
    mock = SimpleNamespace(cache_config=SimpleNamespace(block_size=block_size), use_eagle=False)
