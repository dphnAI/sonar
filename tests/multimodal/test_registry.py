...
def test_dummy_inputs_scheduler_budget(chunked_prefill, max_model_len, expected_seq_len):
    ...
    result = MULTIMODAL_REGISTRY.get_dummy_mm_inputs(model_config, {"image": 1}, processor=processor, **kwargs)
