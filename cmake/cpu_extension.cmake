...
if (CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64|amd64" OR ENABLE_X86_ISA)
    ...
    if (ENABLE_AMX_FP8)
        # Native probability/query conversion also requires AVX10.2 intrinsics.
        ...
        if (COMPILER_SUPPORTS_AMX_FP8_FLAG AND COMPILER_SUPPORTS_AVX10_2_FLAG)
            list(APPEND CXX_COMPILE_FLAGS_AVX512_AMX "-mamx-fp8")
            set(AMX_FP8_SUPPORTED TRUE)
        else()
            set(AMX_FP8_SUPPORTED FALSE)
            message(STATUS "AMX-FP8 disabled: compiler does not support -mamx-fp8 and -mavx10.2 (compiler: ${CMAKE_CXX_COMPILER_ID} ${CMAKE_CXX_COMPILER_VERSION})")
        endif()
    else()
        set(AMX_FP8_SUPPORTED FALSE)
