...
use aphrodite_llm::{Logprobs, PositionLogprobs};
...
/// prompt positions into `scored_positions`, matching Aphrodite's prompt-logprobs semantics.
...
#[cfg(test)]
mod tests {
    use aphrodite_llm::{Logprobs, PositionLogprobs, TokenLogprob};
