...
use aphrodite_text::output::DecodedTextEvent;
...
mod tests {
    ...
    use aphrodite_parser::tool::ToolCallDelta;
    use aphrodite_parser::unified::{UnifiedParserError, UnifiedParserOutput};
    ...
    fn finished_delta(delta: &str) -> aphrodite_text::output::DecodedTextEvent {
        aphrodite_text::output::DecodedTextEvent::TextDelta {
            ...
            token_ids: Vec::new(),
            logprobs: None,
            finished: Some(aphrodite_text::output::Finished {
