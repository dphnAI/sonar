...
pub struct SharedRuntimeArgs {
    ...
    /// Unsupported Python Aphrodite frontend arguments recognized but not yet implemented in Rust.
    #[educe(Debug(ignore))]
    #[command(flatten)]
...
pub struct ServeArgs {
    ...
    /// Additional arguments forwarded to `python -m aphrodite.entrypoints.cli.main serve ...`.
    ///
    /// Arguments after an explicit `--` are forwarded verbatim. Before `--`, `aphrodite-rs serve`
