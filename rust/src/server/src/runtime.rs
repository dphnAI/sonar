...
const REQUEST_WORKER_THREADS_ENV: &str = "APHRODITE_RS_REQUEST_WORKER_THREADS";
...
///
/// If `APHRODITE_RS_REQUEST_WORKER_THREADS` is set to a valid positive integer, it is
