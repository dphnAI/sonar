...
/// Validate one chat completion request and proxy it into the shared `aphrodite-chat` stack.
...
mod tests {
    ...
    use serde_json::json;
    use aphrodite_chat::{AssistantBlockKind, AssistantToolCall, ChatEvent, FinishReason};
    use aphrodite_engine_core_client::protocol::StopReason;
