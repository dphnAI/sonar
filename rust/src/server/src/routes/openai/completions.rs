...
use aphrodite_text::{DecodedTextEvent, FinishReason, TextOutputStream, TextOutputStreamExt as _};
...
/// Validate one completions request and proxy it into the shared `aphrodite-text` stack.
