...
///
/// Mirrors the Python Aphrodite `ChatCompletionRequest` class. The local copy keeps the request type
/// route-owned so we can add Aphrodite-only fields directly instead of layering wrapper deserializers
/// on top.
