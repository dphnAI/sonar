...
/// Serde default for `CompletionRequest::max_tokens`, matching the Python Aphrodite / OpenAI default.
...
///
/// Mirrors the Python Aphrodite `CompletionRequest` class. The local copy keeps the request type
/// route-owned so we can accept token-id prompts via [`aphrodite_text::Prompt`] and add Aphrodite-only
...
pub struct CompletionRequest {
    ...
    /// Python Aphrodite / OpenAI API convention)
