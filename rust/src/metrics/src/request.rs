...
impl RequestMetrics {
    ...
    pub(crate) fn register(registry: &mut Registry) -> Self {
        ...
        registry.register(
            "aphrodite:prompt_tokens_by_source",
        ...
        registry.register(
            "aphrodite:prompt_tokens_cached",
        ...
        let request_max_num_generation_tokens =
            Family::new_with_constructor(request_token_count_histogram as fn() -> Histogram);
        registry.register(
            "aphrodite:request_max_num_generation_tokens",
        ...
        let request_prefill_kv_computed_tokens =
            Family::new_with_constructor(request_token_count_histogram as fn() -> Histogram);
        registry.register(
            "aphrodite:request_prefill_kv_computed_tokens",
        ...
        registry.register(
            "aphrodite:time_to_first_token_seconds",
        ...
        let request_queue_time_seconds =
            Family::new_with_constructor(request_latency_histogram as fn() -> Histogram);
        registry.register(
            "aphrodite:request_queue_time_seconds",
        ...
        let request_prefill_time_seconds =
            Family::new_with_constructor(request_latency_histogram as fn() -> Histogram);
        registry.register(
            "aphrodite:request_prefill_time_seconds",
        ...
        let request_decode_time_seconds =
            Family::new_with_constructor(request_latency_histogram as fn() -> Histogram);
        registry.register(
            "aphrodite:request_decode_time_seconds",
        ...
        let request_inference_time_seconds =
            Family::new_with_constructor(request_latency_histogram as fn() -> Histogram);
        registry.register(
            "aphrodite:request_inference_time_seconds",
        ...
        registry.register(
            "aphrodite:request_time_per_output_token_seconds",
