...
#[derive(Debug, Parser)]
#[command(about = "Smoke-test engine-core sample logprobs against an external Aphrodite engine.")]
struct Args {
    #[arg(long)]
...
async fn wait_for_final_output(
    mut stream: aphrodite_engine_core_client::EngineCoreOutputStream,
