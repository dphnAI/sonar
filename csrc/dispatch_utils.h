...
#define APHRODITE_DISPATCH_VEC_SIZE(VEC_SIZE, ...) \
  switch (VEC_SIZE) {                              \
    case 16: {                                     \
...
#define APHRODITE_DISPATCH_BOOL(expr, const_expr, ...) \
  if (expr) {                                          \
...
#define APHRODITE_DISPATCH_GROUP_SIZE(group_size, const_group_size, ...) \
  if (group_size == 128) {                                               \
...
#define APHRODITE_DISPATCH_RANK234(NUM_DIMS, ...)                              \
  switch (NUM_DIMS) {                                                          \
    case 2: {                                                                  \
