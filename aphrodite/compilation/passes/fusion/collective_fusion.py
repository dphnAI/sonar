...
class FlashInferAllGatherFP4Pattern(
    ...
    def pattern(self) -> Callable[..., torch.Tensor]:
        def _pattern(
            ...
            all_gather_a = torch.ops.aphrodite.all_gather.default(
                a_shard_2d,
                dim=0,
                world_size=self.tp_size,
                group_name=self.tp.unique_name,
            )
            all_gather_a_scale = torch.ops.aphrodite.all_gather.default(
                a_scale_shard,
                dim=0,
                world_size=self.tp_size,
                group_name=self.tp.unique_name,
            ...
            return torch.ops.aphrodite.flashinfer_mm_fp4.default(
                all_gather_a,
                b_2d,
                a_scale,
                b_scale,
    ...
    def replacement(self) -> Callable[..., torch.Tensor]:
        def _replacement(
            ...
            return torch.ops.aphrodite.fused_all_gather_flashinfer_fp4_matmul.default(
                a_shard_2d,
                b_2d,
                a_scale_shard,
                b_scale,
