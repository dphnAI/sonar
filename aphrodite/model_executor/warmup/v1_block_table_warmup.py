...
def warm_v1_block_table_kernels(
    ...
    for block_size in _SLOT_MAPPING_WARMUP_BLOCK_SIZES:
        max_num_blocks_per_req = max(1, (max(num_tokens, max_tokens) + block_size - 1) // block_size)
        ...
        block_table = BlockTable(
            ...
            cp_kv_cache_interleave_size=(_SLOT_MAPPING_WARMUP_CP_KV_CACHE_INTERLEAVE_SIZE),
        )
