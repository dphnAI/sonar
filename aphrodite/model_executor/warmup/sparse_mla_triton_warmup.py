...
def _hf_config_int(runner: "GPUModelRunner", name: str, default: int) -> int:
    model_config = getattr(runner.aphrodite_config, "model_config", None)
...
def _warm_combine_topk_swa_indices_kernel(
    ...
    from aphrodite.models.deepseek_v4.common.ops.cache_utils import combine_topk_swa_indices
