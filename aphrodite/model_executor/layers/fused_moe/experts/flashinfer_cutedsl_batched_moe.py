...
class FlashInferCuteDSLBatchedExperts(mk.FusedMoEExpertsModular):
    def __init__(
        ...
        self.use_deep_ep_ll_nvfp4_dispatch = envs.APHRODITE_DEEPEPLL_NVFP4_DISPATCH and moe_config.use_deepep_ll_kernels
    ...
    def apply(
        ...
        input_global_scale = None if self.use_deep_ep_ll_nvfp4_dispatch else self.a1_gscale
        flashinfer_hidden_states = (hidden_states, a1q_scale) if self.use_deep_ep_ll_nvfp4_dispatch else hidden_states
