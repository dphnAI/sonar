...
from aphrodite.model_executor.layers.fused_moe.oracle.w4a8_int8 import (
...
class CompressedTensorsW4A8Int8MoEMethod(CompressedTensorsMoEMethod):
    ...
    def __init__(
        ...
        if self.group_size != -1 and (
            moe.hidden_dim % self.group_size != 0 or moe.intermediate_size_per_partition % self.group_size != 0
        ):
            raise ValueError(
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        w13_packed, w2_packed, w13_weight_scale, w2_weight_scale, w13_bias, w2_bias = convert_to_w4a8_int8_moe_format(
