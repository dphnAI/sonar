...
def _fwd_kernel_stage1(
    ...
    if split_kv_end > split_kv_start:
        ...
        for start_n in range(split_kv_start, split_kv_end, BLOCK_N):
            ...
            offs_buf_k = (
                (kv_page_number * stride_buf_kpbs + kv_in_page * stride_buf_kbs)[:, None]
            ...
            offs_buf_v = (
                (kv_page_number * stride_buf_vpbs + kv_in_page * stride_buf_vbs)[:, None]
...
def _fwd_grouped_kernel_stage1(
    ...
    if split_kv_end > split_kv_start:
        ...
        for start_n in tl.range(split_kv_start, split_kv_end, BLOCK_N):
            ...
            kv_off_k = kv_page_number * stride_buf_kpbs + (offs_n % PAGE_SIZE) * stride_buf_kbs
            ...
            if not IS_MLA:
                kv_off_v = kv_page_number * stride_buf_vpbs + (offs_n % PAGE_SIZE) * stride_buf_vbs
