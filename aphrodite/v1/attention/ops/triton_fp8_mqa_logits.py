...
tile-size workaround from ROCm/aiter#3257. It is used only while Aphrodite's
pinned AITER version lacks that fix.

TODO: Remove this vendored copy once Aphrodite pins an AITER version that includes
