...
from aphrodite.model_executor.warmup.jit_warmup_triton_helper import TritonWarmupTensor
...
class ComputePrefillMetadataKernel(AphroditeJitKernel["ComputePrefillMetadataKernel.CompileKey"]):
...
class DeepseekSparseSWAMetadataBuilder(AttentionMetadataBuilder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.noncausal_index_width = (
            cdiv(self.window_size + self.num_speculative_tokens, 128) * 128 if self.is_dspark else 0
        )
