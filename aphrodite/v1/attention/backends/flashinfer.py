...
class FlashInferMetadataBuilder(AttentionMetadataBuilder[FlashInferMetadata]):
    ...
    def __init__(
        ...
        self.q_data_type_prefill = self.get_q_data_type(aphrodite_config, self.kv_cache_spec, is_prefill=True)
        self.q_data_type_decode = self.get_q_data_type(aphrodite_config, self.kv_cache_spec, is_prefill=False)
        ...
        self._init_reorder_batch_threshold(1, supports_spec_as_decode=supports_spec_as_decode)
    ...
    def get_q_data_type(
        ...
        if aphrodite_config.attention_config.disable_flashinfer_q_quantization:
    ...
    def build(
        ...
        decode_with_flashinfer_trtllm_api = causal and self.use_trtllm_decode_attention and self.dcp_world_size <= 1
