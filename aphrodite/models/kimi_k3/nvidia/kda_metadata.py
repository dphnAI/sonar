...
class KimiK3KDAMetadataBuilder(GDNAttentionMetadataBuilder):
    ...
    def build(  # type: ignore[override]
        ...
        checkpoint = None
        checkpoint_enabled = (
            self.aphrodite_config.cache_config.mamba_cache_mode == "align"
        ...
        if num_prefills > 0 and checkpoint_enabled:
            ...
            hash_block_size = self.aphrodite_config.cache_config.prefix_match_unit or block_size
            speculative_config = self.aphrodite_config.speculative_config
            drop_eagle_block = speculative_config is not None and speculative_config.use_eagle_block_drop()
            checkpoint_splits = []
            checkpoint_cols = []
