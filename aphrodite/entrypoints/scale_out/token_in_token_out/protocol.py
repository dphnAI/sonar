...
class MultiModalFeatures(BaseModel):
    ...
    def _validate_parallel_fields(self) -> "MultiModalFeatures":
        ...
        for modality in modalities:
            ...
            if self.mm_metadata is not None and len(self.mm_metadata[modality]) != num_hashes:
                raise ValueError(f"{modality} mm_metadata and mm_hashes must have the same length")
