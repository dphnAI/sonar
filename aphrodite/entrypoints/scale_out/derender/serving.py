...
from aphrodite.entrypoints.openai.chat_completion.protocol import ChatCompletionResponse
from aphrodite.entrypoints.openai.completion.protocol import CompletionResponse
