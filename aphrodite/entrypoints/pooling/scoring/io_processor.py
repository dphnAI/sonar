...
from aphrodite import PoolingParams, PoolingRequestOutput, PromptType, TokensPrompt
...
class CrossEncoderIOProcessor(ScoringIOProcessor):
    ...
    def render(
        ...
        max_tokens_per_query, max_tokens_per_doc = self._get_token_limits(pooling_params=params)
        ...
        if token_type_ids := engine_prompt.pop("token_type_ids", None):
            token_type_ids = _apply_post_tokenization_to_token_type_ids(self.tokenizer, tok_params, token_type_ids)
