...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "APHRODITE_GPU_SYNC_CHECK": env_with_choices(
        "APHRODITE_GPU_SYNC_CHECK", None, ["warn", "error"]
    ),
    ...
    "APHRODITE_ENABLE_PREGRAD_PASSES": lambda: (
        os.environ.get("APHRODITE_ENABLE_PREGRAD_PASSES", "1") == "1"
    ),
    # Experimental: breakable cudagraph does not rely on torch.compile
    "APHRODITE_USE_BREAKABLE_CUDAGRAPH": lambda: (
        os.environ.get("APHRODITE_USE_BREAKABLE_CUDAGRAPH", "0") == "1"
    ),
    ...
    "APHRODITE_USE_RAY_V2_EXECUTOR_BACKEND": lambda: bool(
        int(os.getenv("APHRODITE_USE_RAY_V2_EXECUTOR_BACKEND", "1"))
    ),
    ...
    "APHRODITE_DISTRIBUTED_USE_SPLIT_GROUP": lambda: bool(
        int(os.getenv("APHRODITE_DISTRIBUTED_USE_SPLIT_GROUP", "0"))
    ),
    ...
    "APHRODITE_MAX_AUDIO_DECODE_DURATION_S": lambda: int(
        os.getenv("APHRODITE_MAX_AUDIO_DECODE_DURATION_S", "600")
    ),
    ...
    "APHRODITE_MAX_IMAGE_PIXELS": lambda: int(
        os.getenv("APHRODITE_MAX_IMAGE_PIXELS", "178956970")
    ),
    ...
    "APHRODITE_FASTSAFETENSORS_QUEUE_SIZE": lambda: int(
        os.getenv("APHRODITE_FASTSAFETENSORS_QUEUE_SIZE", "0")
    ),
    ...
    "APHRODITE_TRITON_FORCE_FIRST_CONFIG": lambda: (
        os.environ.get("APHRODITE_TRITON_FORCE_FIRST_CONFIG", "0").strip().lower()
        in ("1", "true")
    ),
    ...
    "APHRODITE_MXFP8_EMULATION_DEQUANT_AT_LOAD": lambda: (
        os.getenv("APHRODITE_MXFP8_EMULATION_DEQUANT_AT_LOAD", "True").lower()
        in ("true", "1")
    ),
    ...
    "APHRODITE_ROCM_AITER_MOE_DISPATCH_POLICY": lambda: int(
        os.getenv("APHRODITE_ROCM_AITER_MOE_DISPATCH_POLICY", "0")
    ),
    ...
    # process(es).
    "APHRODITE_USE_RUST_FRONTEND": lambda: bool(
        int(os.getenv("APHRODITE_USE_RUST_FRONTEND", "0"))
    ),
    ...
    # This environment variable is ignored if data-parallel-backend is not Ray.
    "APHRODITE_RAY_DP_PLACEMENT_NODE_IPS": lambda: os.getenv(
        "APHRODITE_RAY_DP_PLACEMENT_NODE_IPS", ""
    ),
    ...
    "APHRODITE_HUMMING_MOE_GEMM_TYPE": lambda: os.environ.get(
        "APHRODITE_HUMMING_MOE_GEMM_TYPE", None
    ),
    ...
    "APHRODITE_REGEX_COMPILATION_TIMEOUT_S": lambda: int(
        os.getenv("APHRODITE_REGEX_COMPILATION_TIMEOUT_S", "5")
    ),
    ...
    "APHRODITE_MOONCAKE_LOAD_RECV_THREADS": lambda: int(
        os.getenv("APHRODITE_MOONCAKE_LOAD_RECV_THREADS", "1")
    ),
    ...
    "APHRODITE_FLASHINFER_AUTOTUNE_CACHE_DIR": lambda: os.getenv(
        "APHRODITE_FLASHINFER_AUTOTUNE_CACHE_DIR", None
    ),
    ...
    "APHRODITE_DEEPEP_V2_ALLOW_HYBRID_MODE": lambda: bool(
        int(os.getenv("APHRODITE_DEEPEP_V2_ALLOW_HYBRID_MODE", "0"))
    ),
    # DeepEP v2: use fewer SMs at slight throughput cost
    "APHRODITE_DEEPEP_V2_PREFER_OVERLAP": lambda: bool(
        int(os.getenv("APHRODITE_DEEPEP_V2_PREFER_OVERLAP", "0"))
    ),
    ...
    "APHRODITE_USE_V2_MODEL_RUNNER": lambda: maybe_convert_bool(
        os.getenv("APHRODITE_USE_V2_MODEL_RUNNER", None)
    ),
    ...
    # or v2 model runner).
    "APHRODITE_WSL2_ENABLE_PIN_MEMORY": lambda: bool(
        int(os.getenv("APHRODITE_WSL2_ENABLE_PIN_MEMORY", "0"))
    ),
    ...
    "APHRODITE_SKIP_MODEL_NAME_VALIDATION": lambda: (
        os.getenv("APHRODITE_SKIP_MODEL_NAME_VALIDATION", "0").strip().lower()
        in ("1", "true")
    ),
    ...
    "APHRODITE_LOG_ROUTES": env_with_choices(
        "APHRODITE_LOG_ROUTES", "compact", ["off", "compact", "full"]
    ),
    ...
    "APHRODITE_XPU_USE_SAMPLER_KERNEL": lambda: bool(
        int(os.getenv("APHRODITE_XPU_USE_SAMPLER_KERNEL", "1"))
    ),
