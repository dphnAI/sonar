...
from aphrodite.distributed.weight_transfer.nccl_engine import NCCLTrainerSendWeightsArgs
...
class SparseNCCLWeightTransferEngine(
    ...
    def trainer_send_weights(
        ...
        """Broadcast sparse flat-index patches from trainer to Aphrodite workers."""
