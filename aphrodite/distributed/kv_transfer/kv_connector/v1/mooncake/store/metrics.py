...
class MooncakeStorePromMetrics(KVConnectorPromMetrics):
    ...
    def __init__(
        ...
        self._histogram_operation_time = self._histogram_cls(
            name="aphrodite:mooncake_store_operation_time_seconds",
