...
class NixlBaseConnectorWorker:
    ...
    def __init__(
        ...
        kv_lease_duration: int = aphrodite_config.kv_transfer_config.get_from_extra_config(
        ...
        self._engine_ttl: float = aphrodite_config.kv_transfer_config.get_from_extra_config(
            "engine_ttl", 3600.0
        )
